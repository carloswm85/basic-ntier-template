...
| -------------------------- | --------------------------------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `main`                     |                                   |                                                         | [🔗]()                                                                                 |
| `dev-lightweight-netcore8` | NET Core 8 _without_ Identity API | FINISHED. It can be used for development.               | [🔗](https://github.com/carloswm85/basic-ntier-template/tree/dev-lightweight-netcore8) |
| `dev-identity-netcore8`    | NET Core 8 _WITH_ Identity API    | UNFINISHED. `dev-lightweight-netcore8` + _Identity API_ | [🔗](https://github.com/carloswm85/basic-ntier-template/tree/dev-identity-netcore8)    |
