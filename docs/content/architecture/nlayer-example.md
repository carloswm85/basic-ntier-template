- [Layered (N-Layer) Architecture in .NET Core](#layered-n-layer-architecture-in-net-core)
  - [Overview](#overview)
...
- [N-Layer Example Diagram](#n-layer-example-diagram)

---

# Layered (N-Layer) Architecture in .NET Core
...
- N-Layer: <https://github.com/carloswm85/dotnet-template-kit>
- DDD: ???
- Vertical Slice: ???
...
| Nº  | Attribute               | **N-Layer (Layered)**                           | **DDD (Domain-Driven Design)**                 | **Vertical Slice Architecture**                      | **Clean Architecture**                                          |
| --- | ----------------------- | ---------------------------------------------- | ---------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------------------- |
