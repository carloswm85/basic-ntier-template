...
- Create Angular project with ng: `ng new complexnlayertemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`complexnlayertemplate.client.esproj`).
