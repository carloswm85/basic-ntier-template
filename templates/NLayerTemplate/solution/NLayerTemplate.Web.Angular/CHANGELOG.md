...
- Create Angular project with ng: `ng new nlayertemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`nlayertemplate.client.esproj`).
