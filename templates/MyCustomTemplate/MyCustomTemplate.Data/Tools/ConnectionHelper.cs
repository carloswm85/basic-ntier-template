...
namespace MyCustomTemplate.Data.Tools
{
    ...
    public class ConnectionHelper
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MyCustomTemplateContext"/> using the connection 
        ...
        /// </param>
        /// <returns>
        /// A fully configured <see cref="MyCustomTemplateContext"/> ready for database operations.
        /// </returns>
        public static MyCustomTemplateContext CreateConnection(ConnectionResource connectionResource)
        {
