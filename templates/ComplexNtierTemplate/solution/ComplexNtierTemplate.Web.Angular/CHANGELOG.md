...
- Create Angular project with ng: `ng new complexntiertemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`complexntiertemplate.client.esproj`).
