...
using ComplexNtierTemplate.Repository;
using ComplexNtierTemplate.Service.Mappings.ContosoUniversity;
using ComplexNtierTemplate.Service.Services.ExampleServices;
using ComplexNtierTemplate.Service.Services.ExampleServices.Interfaces;
using ComplexNtierTemplate.Web.API.Constants;
using Microsoft.EntityFrameworkCore;
using Microsoft.OpenApi;

namespace ComplexNtierTemplate.Web.API;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        // DbContext
        services.AddDbContext<ComplexNtierTemplateDbContext>(options =>
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Version = "v1",
                Title = "ComplexNtierTemplate API V1",
            ...
            {
                Version = "v2",
                Title = "ComplexNtierTemplate API V2",
                Description = "An ASP.NET Core Web API for your resourses.",
                TermsOfService = new Uri("https://example.com/terms")
            });
