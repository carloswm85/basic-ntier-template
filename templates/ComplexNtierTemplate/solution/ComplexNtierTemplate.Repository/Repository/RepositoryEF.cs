using ComplexNtierTemplate.Data;
using ComplexNtierTemplate.Data.Model;
using Microsoft.EntityFrameworkCore;

namespace ComplexNtierTemplate.Repository
{
    ...
    public class RepositoryEF<TEntity> : IRepository<TEntity> where TEntity : class, IEntity
    {
        ...
        private readonly ComplexNtierTemplateDbContext _dbContext;
        ...
        public RepositoryEF(ComplexNtierTemplateDbContext dbContext)
        {
