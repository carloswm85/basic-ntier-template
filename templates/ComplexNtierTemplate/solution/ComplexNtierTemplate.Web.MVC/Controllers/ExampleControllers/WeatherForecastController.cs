...
namespace ComplexNtierTemplate.Web.MVC.Controllers.ExampleControllers;
...
public class WeatherForecastController : Controller
{
    ...
    public IActionResult ApiInstructions()
    {
        var instructions = @"
                ...
                1. Run the ComplexNtierTemplace.API project using your favorite method. 
                ...
                2. Run the ComplexNtierTemplace.Web.MVC at the same time.
