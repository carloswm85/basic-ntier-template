...
`ComplexNtierTemplate` is a Clean Architecture variant. For better understanding, we'll highlight here the similarities between the two.
...
```mermaid
---
title: "- Complex Ntier Template Architecture Diagram -"
config:
  theme: dark
  themeVariables:
    {
