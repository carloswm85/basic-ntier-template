...
2. Run the `ComplexNtierTemplate.Web.API` project separately from the `ComplexNtierTemplate.Web.Angular` poject.
...
2. At `ComplexNtierTemplate.Web.API\Properties\launchSettings.json`, uncomment lines:

```json
"ASPNETCORE_HOSTINGSTARTUPASSEMBLIES": "Microsoft.AspNetCore.SpaProxy"
```

3. At `ComplexNtierTemplate.Web.API\ComplexNtierTemplate.Web.API.csproj` uncomment:

```xml
<!-- Angular Project
-->
<SpaProxyLaunchCommand>npm start</SpaProxyLaunchCommand>
<SpaRoot>..\ComplexNtierTemplate.Web.Angular</SpaRoot>
<SpaProxyServerUrl>https://localhost:5021</SpaProxyServerUrl>
```

4. When debugging `ComplexNtierTemplate.Web.API`, the Angular SPA will be launched (`ComplexNtierTemplate.Web.Angular`).
...
- Run `ComplexNtierTemplate.Web.API` without following the previous steps.
