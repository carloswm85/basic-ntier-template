...
- Create Angular project with ng: `ng new basicntiertemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`basicntiertemplate.client.esproj`).
